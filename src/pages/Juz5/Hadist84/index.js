...
const HalamanHadist84 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-84</Text>
...
paddingTop:20}}>Tujuh Puluh Cabang Iman</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>الْإِيمَانُ بِضْعٌ وَسِتُّونَ أَوْ سَبْعُونَ شُعْبَةً،
أَفْضَلُهَا قَوْلُ لاَ إِلَهَ إِلاَّ اللهُ، وَأَدْنَاهَا إِمَاطَةُ
الأَذَى عَنِ الطَّرِيقِ، وَالْحَيَاءُ شُعْبَةٌ مِنَ
الْإِيمَانِ (رواه البخاري ومسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Iman itu memiliki tujuh puluh cabang (riwayat lain tujuh puluh tujuh cabang). Yang paling utama ialah Laa ilaaha illa Allah dan yang terendah ialah membuang duri dari jalan. Dan malu juga merupakan salah satu cabang iman.” (Riwayat Bukhari dan muslim).
...
<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist83')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist85')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist84