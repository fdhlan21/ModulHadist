...
const HalamanHadist77 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-77</Text>
...
paddingTop:20}}>Keutamaan Laa Ilaaha Illallaah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَنْ قَالَ لاَ إِلَهَ إِلاَّ اللهُ وَكَفَرَ بِمَا يُعْبَدُ مِنْ
دُونِ اللهِ حَرُمَ مَالُهُ وَدَمُهُ وَحِسَابُهُ عَلَى اللهِ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Barangsiapa yang mengucapkan Laailaahaillallaah (tidak ada tuhan yang berhak disembah selain Allah) dan mengingkari sesembahan selain Allah, maka terpeliharalah darah dan hartanya, dan hisabnya (terhadap urusan batinnya) terserah kepada Allah.” (HR. Muslim)
</Text>
</TouchableOpacity>
</View>
...
export default HalamanHadist77