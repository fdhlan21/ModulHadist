...
const HalamanHadist88 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-88</Text>
...
paddingTop:20}}>Beratnya Resiko Menuduh Orang Muslim Kafir</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِذَا قَالَ الرَّجُلُ لِأَخِيْهِ" يَاكَافِر"، فَقَدْ بَاءَ بِهِ
أَحَدُهُمَا (رواه البخارى)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Apabila ada seseorang yang berkata kepada saudaranya, “Wahai kafir”, maka sungguh ucapan itu akan kembali kepada salah satunya.” (HR. Al-Bukhari)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity  activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist87')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity  activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist89')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist88