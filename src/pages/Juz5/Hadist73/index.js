...
const HalamanHadist73 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-73</Text>
...
paddingTop:20}}>Perbandingan antara Orang yang Mengingat Allah dan yang Tidak</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَثَلُ الَّذِيْ يَذْكُرُ رَبَّهُ وَالَّذِيْ لَا يَذْكُرُ رَبَّهُ مَثَلُ
الْحَيِّ وَالْمَيِّتِ (رواه البخاري)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Perumpamaan orang yang mengingat Allah dengan yang tidak mengingat Allah seperti orang yang hidup dengan orang yang mati.“ (HR. Al-Bukhari)
...
<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist72')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist73