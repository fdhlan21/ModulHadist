...
const HalamanHadist82 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-82</Text>
...
paddingTop:20}}>Hadits tentang Ihsan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:1}}>الْإِحْسَانُ أَنْ تَعْبُدَ اللهَ كَأَنَّكَ تَرَاهُ فَإِنْ لَمْ
تَكُنْ تَرَاهُ فَإِنُّهُ يَرَاكَ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
"Ihsan adalah engkau beribadah kepada Allah seakan-akan engkau melihat-Nya, jika engkau tidak melihat-Nya maka Dia melihat engkau.” (HR. Muslim)
</Text>
</TouchableOpacity>
</View>
...
export default HalamanHadist82