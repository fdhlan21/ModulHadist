...
const HalamanHadist91 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-91</Text>
...
paddingTop:20}}>Tidak Boleh Mencaci Orang yang Sudah Meninggal</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>لاَتَسُبُّوا اْلأَمْواَتَ فَإِنَّهُمْ قَدْ أَفْضَوْا إِلَى
مَاقَدَّمُوْا (رواه البخارى)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Janganlah kalian mencaci orang yang telah meninggal dunia, karena sesungguhnya mereka telah sampai kepada apa yang mereka kerjakan.” (HR. Al-Bukhari)
...
export default HalamanHadist91