...
const HalamanHadist89 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-89</Text>
...
paddingTop:20}}>Larangan Memerangi Umat Islam dan Berbuat Curang</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20}}>مَنْ حَمَلَ عَلَيْنَا السِّلاَحَ فَلَيْسَ مِنَّا وَمَنْ غَشَّنَا
فَلَيْسَ مِنَّا (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Barangsiapa memerangi kami maka ia tidak termasuk golongan kami, dan barangsiapa berbuat curang terhadap kami maka ia tidak termasuk golongan kami.” (HR Muslim)
...
<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist88')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist90')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist89