...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-99</Text>
...
paddingTop:20}}>Keutamaan Bersholawat kepada Nabi</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20}}>عَنْ أَبِيْ هُرَيْرَةَ رَضِيَ اللهُ عَنْهُ أَنَّ رَسُوْلَ اللهِ 
صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ قَالَ: مَنْ صَلَّى عَلَيَّ 
وَاحِدَةً صَلَّى اللهُ عَلَيْهِ عَشْرًا (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Dari Abu Hurairah radhiyallahu 'anhu, bahwa Rasulullah shallalahu alaihi wa sallam bersabda, Barangsiapa bersholawat kepadaku satu kali, maka Allah akan bersholawat kepadanya sepuluh kali.” (HR. Muslim)
