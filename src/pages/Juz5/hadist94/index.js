...
const HalamanHadist94 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-94</Text>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>عَنْ عُمَرَ بْنِ أَبِى سَلَمَةَ قَالَ: كُنْتُ فِى حَجْرِ 
رَسُوْلِ اللهِ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ وَكَانَتْ يَدِيْ 
تَطِيشُ فِى الصَّحْفَةِ فَقَالَ لِى:" يَا غُلاَمُ سَمِّ 
اللهَ وَكُلْ بِيَمِينِكَ وَكُلْ مِمَّا يَلِيْكَ" . فَمَا زَالَتْ 
تِلْكَ طُعْمَتِي بَعْدُ (رواه البخاري ومسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
Dari Umar bin Abi Salamah berkata, “Semasa aku masih di bawah pengasuhan Rasulullah shallalahu alaihi wa sallam. Tanganku (ketika makan) menjangkau kemana-mana di dalam hidangan. Beliau berkata kepadaku, “Nak, Sebutlah nama Allah, makanlah dengan tangan kanan dan makanlah dari yang terdekat denganmu.” Maka begitulah cara makanku setelah itu.” (HR. Al-Bukhari dan Muslim)
...
<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist93')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist94