...
const HalamanHadist90= ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-90</Text>
...
paddingTop:20}}>Yang Harus Dilakukan Kepada Orang yang Akan Mati</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>لَقِّنُوْا مَوْتَاكُمْ لاَإِلَهَ إلاَّ اللهُ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Talqinlah (ajarilah) orang yang mau meninggal dunia dengan kalimat LAA ILAHA ILLALLAH.” (HR. Muslim)
...
export default HalamanHadist90