...
const HalamanHadist71 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-71</Text>
...
paddingTop:20}}>Pahala Bagi Ahli Masjid</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَنْ غَدَا إِلَى الْمَسجِدِ أَوْ رَاحَ أَعَدَّ اللهُ لَهُ فِي
الجَنَّةِ نُزُلاً كُلَّمَا غَدَا أَوْ رَاحَ (متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Barangsiapa pergi atau pulang dari masjid, maka Allah menyiapkan baginya tempat tinggal di Surga setiap kali ia pergi dan pulang darinya.” (Muttafaq 'Alaihi)
...
export default HalamanHadist71