...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-97</Text>
...
paddingTop:20}}>Amalan yang Paling Dicintai oleh Allah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>عَنْ عَائِشَةَ رَضِيَ اللهُ عَنْهَا أَنَّ رَسُوْلَ اللهِ صَلَّى 
اللهُ عَلَيْهِ وَسَلَّمَ قَالَ: أَحَبُّ الْأَعْمَالِ إِلَى اللهِ 
تَعَالَى أَدْوَمُهَا وَإِنْ قَلَّ (متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Dari Aisyah radhiyallahu 'anha bahwa Rasulullah shallalahu alaihi wa sallam bersabda, Amalan yang paling dicintai oleh Allah ta'ala adalah yang berkesinambungan (konsisten) meskipun sedikit.” (Muttafaqun 'Alaihi)
...
<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist96')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist98')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
