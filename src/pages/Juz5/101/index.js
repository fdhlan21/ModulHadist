...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-101</Text>
...
paddingTop:20}}>Beginilah Manusia ketika Dibangkitkan pada Hari Kiamat</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>عَنْ جَابِر بْنِ عَبْدِ اللهِ رَضِيَ اللهُ عَنْهُ قَالَ: 
سَمِعْتُ النَّبِيُّ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ يَقُوْلُ يُبْعَثُ 
كُلُّ عَبْدٍ عَلَى مَا مَاتَ عَلَيْهِ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
Dari Jabir bin Abdillah radhiyallahu 'anhu, ia berkata, “Saya mendengar Nabi shallalahu alaihi wa sallam bersabda, “Setiap hamba akan dibangkitkan (pada hari kiamat) dalam keadaan ia mati di atasnya.” (HR. Muslim)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist100')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist102')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
