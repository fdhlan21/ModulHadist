...
const HalamanHadist83 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-83</Text>
...
paddingTop:20}}>Perintah Berpegang Teguh dengan Umat Terbaik</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>عَلَيْكُمْ بِسُنَّتِي وَسُنَّةِ الْخُلَفَاءِ الرَّاشِدِيْنَ
الْمَهْدِيِّيْنَ، عَضُّوا عَلَيْهَا بِالنَّوَاجِذِ، وَإِيَّاكُمْ
وَمُحْدَثَاتِ اْلأُمُوْرِ، فَإِنَّ كُلَّ بِدْعَةٍ ضَلاَلَةٌ
(رَوَاه ابو داود والترمذي وقال : حديث حسن صحيح)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Hendaklah kalian berpegang teguh terhadap ajaranku dan ajaran Khulafaurrasyidin yang mendapatkan petunjuk, gigitlah (genggamlah dengan kuat) dengan geraham. Hendaklah kalian menghindari perkara yang diada-adakan, karena semua perkara bid’ah adalah sesat “ (Riwayat Abu Daud dan At-Tirmidzi, dia berkata: Hadits hasan shahih).
...
export default HalamanHadist83