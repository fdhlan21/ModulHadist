...
const HalamanHadist72 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-72</Text>
...
paddingTop:20}}>Mengucap Salam</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>عَنْ أَنَسٍ رَضِيَ اللهُ عَنْهُ قَالَ، قَالَ لِي رَسُوْلُ
اللهِ صَلَّى اللهُ عَلَيْهِ وَسَلَّمْ: " يَابُنَيَّ، إِذَا دَخَلْتَ
عَلَى أَهْلِكَ فَسَلِّمْ يَكُنْ بَرَكَةً عَلَيْكَ وَعَلَى أَهْلِ
بَيْتِكَ" (رواه الترميذي وصححه الباني)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Dari Anas radhiyallahu ‘anhu. Ia berkata, bahwa Rasulullah shallallahu ‘alaihi wasallam pernah bersabda kepadaku, “Hai Anakku, apabila kamu menemui keluargamu, maka ucapkan salam agar berkah Allah turun kepadamu dan seluruh penghuni rumahmu.”
...
export default HalamanHadist72