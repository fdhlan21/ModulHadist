...
const HalamanHadist86 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-86</Text>
...
paddingTop:20}}>Sumpah dengan Nama Allah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>منْ كاَنَ حَالِفًا فَلْيَحْلِفْ بِاللهِ أَوْ لِيَصْمُت (رواه البخاري)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Barangsiapa yang mau bersumpah maka hendaknya dia bersumpah dengan nama Allah atau dia diam saja.” (HR. Al-Bukhari)
...
export default HalamanHadist86