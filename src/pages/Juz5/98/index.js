...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-98</Text>
...
paddingTop:20}}>Keistimewaan Dzikir Rasulullah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>عَنْ عَائِشَةَ رَضِيَ اللهُ عَنْهَا قَالَتْ: كَانَ النَّبِيُّ 
صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ يَذْكُرُ اللهَ عَلَى كُلِّ أَحْيَانِهِ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
”Dari Aisyah radhiyallahu 'anha, ia berkata, Adalah Nabi shallalahu alaihi wa sallam berdzikir kepada Allah pada setiap waktunya.” (HR. Muslim)
</Text>
</TouchableOpacity>
</View>
