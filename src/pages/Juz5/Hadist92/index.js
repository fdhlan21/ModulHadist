...
const HalamanHadist92 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-92</Text>
...
paddingTop:20}}>Besarnya Hak Tetangga</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَازَالَ جِبْرِيْلُ يُوْصِينِي بِالْجاَرِ حَتَّى ظَنَنْتُ أَنَّهُ
سَيُوَرِّثُهُ (متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Senantiasa Jibril berwasiat kepadaku tentang tetangga, sehingga aku mengira bahwa dia akan memberikan warisan untuknya.” (Muttafaq Alaih)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist91')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist92