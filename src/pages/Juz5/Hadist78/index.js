...
const HalamanHadist78 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-78</Text>
...
paddingTop:20}}>Jaminan Surga bagi Hamba yang Tidak Syirik dan Ancaman Neraka bagi yang Syirik</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَنْ لَقِيَ اللهَ لاَ يُشْرِكُ بِهِ شَيْئًا دَخَلَ الْجَنَّةَ
وَمَنْ لَقِيَهُ يُشْرِكُ بِهِ دَخَلَ النَّارَ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Barangsiapa bertemu Allah dalam keadaan tidak menyekutukan-Nya dengan sesuatu, maka dia masuk surga, dan barangsiapa yang bertemu dengan-Nya dalam keadaan menyekutukan-Nya dengan sesuatu, maka ia akan masuk neraka.” (HR. Muslim)
...
export default HalamanHadist78