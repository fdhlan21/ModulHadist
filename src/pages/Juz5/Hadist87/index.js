...
const HalamanHadist87 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-87</Text>
...
paddingTop:20}}>Ketentuan Allah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>كَتَبَ اللهُ مَقَادِيرَ الْخَلاَ ئِقِ قَبْلَ أَنْ يَخْلُقَ
السَّمَاوَاتِ وَالأَرْضَ بِخَمْسِينَ أَلْفَ سَنَةٍ، قَالَ
وَعَرْشُهُ عَلَى الْمَاءِ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
"Allah telah menentukan takdir bagi semua makhluk lima puluh ribu tahun sebelum Allah menciptakan langit dan bumi.” Rasulullah menambahkan:”Dan arsy Allah itu berada di atas air." (HR. Muslim)
...
export default HalamanHadist87