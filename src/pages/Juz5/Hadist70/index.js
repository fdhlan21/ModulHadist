...
const HalamanHadist70 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-70</Text>
...
paddingTop:20}}>Adab Buang Hajat</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِذَا بَالَ أَحَدُكُمْ فَلاَ يَمَسَّ ذَكَرَهُ بِيَمِيْنِهِ، وَلاَ
يَتَنَفَّسْ فِى الْإِنَاءِ، وَلاَ يَسْتَنْجِ بِيَمِيْنِهِ (رواه البخاري ومسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Jika seseorang dari kalian buang air kecil, janganlah sekali-kali memegang kemaluannya dengan tangan kanan, jangan bernafas (meniup) dalam bejana, dan jangan cebok dengan tangan kanan.” (HR. Al-Bukhari dan Muslim)
...
<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist69')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist71')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist70