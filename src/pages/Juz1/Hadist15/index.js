...
const HalamanHadist15 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,  left:10, top:0}}>HADIST Ke-15</Text>
...
paddingTop:20, paddingLeft:7}}>Kewajiban Menuntut Ilmu</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:22, letterSpacing:2}}>طَلَبُ العِلْمِ فَرِيْضَةٌ عَلَى كُلِّ مُسْلِمٍ (رواه مسلم)</Text>
</TouchableOpacity>
...
export default HalamanHadist15