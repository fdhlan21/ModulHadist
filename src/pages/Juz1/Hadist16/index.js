...
const HalamanHadist16 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,  left:10, top:0}}>HADIST Ke-16</Text>
...
paddingTop:20, paddingLeft:7}}>Memulai Dari Sebelah Kanan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:22, letterSpacing:2}}>كَانَ النَّبِيُّ صَلَّى اللّٰهُ عَلَيْهِ وَسَلَّمَ يُحِبُّ التَّيَمُّنَ
مَا اسْتَطَاعَ فِيْ شَأْنِهِ كُلِّهِ فِي طُهُوْرِهِ وَتَرَجُّلِهِ
وَتَنَعُلِّهِ (رواه البخارى)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
”Adalah Nabi shallallahu ‘alaihi wasallam suka memulai dari yang kanan dalam semua keadaan (yang baik) selama ia mampu, baik ketika bersuci, menyisir rambut, dan memakai sandal.” 
(HR. Al-Bukhari)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity activeOpacity={1}   onPress={()=> navigation.navigate('HalamanHadist15')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>

<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist17')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist16