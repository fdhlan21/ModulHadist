import { View, Text, Image, useColorScheme, ScrollView, SafeAreaView, TouchableOpacity, Switch,   StyleSheet} from 'react-native'
...
const HalamanHadist1 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-1</Text>
...
paddingTop:20}}>Menjaga Hak Allah</Text>
</TouchableOpacity>
<TouchableOpacity onPress={handleCopy}>
...
paddingTop:40, lineHeight:70, paddingRight:20, fontStyle:'normal', letterSpacing:2}}>اِحْفَظِ اللهَ يَحْفَظْكَ، اِحْفَظِ اللهَ تَجِدْهُ تُجَاهَكَ (رواه الترمذي وقال حديث حسن صحيح)</Text>
</TouchableOpacity>
<TouchableOpacity onPress={handleCopy}>
...
Artinya: {'\n'}
"Jagalah Allah, Niscaya Allah menjagamu, jagalah Allah, niscaya engkau mendapati-Nya dihadapanmu." 
