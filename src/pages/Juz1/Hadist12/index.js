...
const HalamanHadist12 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,  left:10, top:0}}>HADIST Ke-12</Text>
...
paddingTop:20, paddingLeft:7}}>Hukuman bagi yang Memutus Silaturahim</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>لاَ يَدْخُلُ الْجَنَّةَ قَاطِعُ رَحِمٍ (رواه البخاري ومسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Tidak masuk surga orang yang memutuskan kekerabatan.” 
...
export default HalamanHadist12