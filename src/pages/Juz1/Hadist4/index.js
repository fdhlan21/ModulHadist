...
const HalamanHadist4 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,  left:10, top:0}}>HADIST Ke-4</Text>
...
paddingTop:20}}>Kebaikan akan Menghapus Kejahatan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>وَأَتْبِعِ السَّيِّئَةَ الْحَسَنَةَ تَمْحُهَا
(رَوَاهُ التِّرْمِذِي وقال حديث حسن صحيح)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Sertakanlah olehmu kejahatan dengan kebaikan niscaya ia akan menghapuskannya (kejahatan tersebut).”
...
<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist5')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
