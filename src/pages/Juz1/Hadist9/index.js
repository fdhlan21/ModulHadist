...
const HalamanHadist9 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,  left:10, top:0}}>HADIST Ke-9</Text>
...
paddingTop:20}}>Larangan Makan dengan Tangan Kiri</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:22, letterSpacing:2}}>لاَ تَأْكُلُوْا بِالشِّمَالِ فَإِنَّ الشَّيْطَانَ يَأْكُلُ بِالشِّمَالِ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Janganlah kalian makan dengan tangan kiri, karena sesungguhnya setan itu makan dengan tangan kiri.” (HR. Muslim)
