...
const HalamanHadist8 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,  left:10, top:0}}>HADIST Ke-8</Text>
...
paddingTop:20}}>Tidak Mencela Makanan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَا عَابَ النَّبِيُّ صَلَّى الله عَلَيْهِ وَسَلَّمَ طَعَامًا قَطُّ
إِنِ اشْتَهَاهُ أَكَلَهُ وَإِنْ كَرِهَهُ تَرَكَهُ (مُتَّفَقٌ عَلَيهِ)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Nabi shallallahu ‘alaihi wasallam tidak pernah mencela makanan, apabila ia menyukainya maka beliau memakannya, dan apabila membencinya, maka beliau meninggalkannya.” (Muttafaq 'Alaih)
...
<TouchableOpacity  activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist7')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
