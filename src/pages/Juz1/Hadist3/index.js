...
const HalamanHadist3 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,   left:10, top:0}}>HADIST Ke-3</Text>
...
paddingTop:20}}>Perintah Bertaqwa</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20,  letterSpacing:2}}>اِتَّقِ الله حَيْثُماَ كُنْتَ 
