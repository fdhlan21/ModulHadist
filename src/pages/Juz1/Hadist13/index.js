...
const HalamanHadist13 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,  left:10, top:0}}>HADIST Ke-13</Text>
...
paddingTop:20, paddingLeft:7}}>Tak Disayang Siapa yang Tidak Menyayangi</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:29, letterSpacing:2}}>لاَ يَرْحَمُ اللهُ مَنْ لاَ يَرْحَمِ النَّاسَ 
(رواه البخاري ومسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Tidak disayangi Allah orang yang tidak mau menyayangi manusia.” 
...
<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist14')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist13