...
const HalamanHadist2 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-2</Text>
...
paddingTop:20}}>Meminta dan Memohon Pertolongan hanya kepada Allah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20,  letterSpacing:2}}>إِذاَ سَأَلْتَ فَسْأَلِ اللهَ وَإِذَا اسْتَعَنْتَ فَاسْتَعِنْ بِاللهِ (رواه الترمذي وقال حديث حسن صحيح)</Text>
</TouchableOpacity>
<TouchableOpacity onPress={handleCopy}>
...
Artinya:{'\n'}
“Jika kamu meminta, maka mintalah kepada Allah, dan bila kamu memohon pertolongan mohonlah kepada Allah.” 
(HR. At-Tirmidzi, dia berkata: Hadits hasan shohih)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist1')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>

<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist3')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
