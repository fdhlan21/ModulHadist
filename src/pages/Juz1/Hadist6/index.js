...
const HalamanHadist6 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23,  left:10, top:0}}>HADIST Ke-6</Text>
...
paddingTop:20}}>Jaminan Allah Bagi Orang yang Tidak Berbuat Syirik</Text>
</TouchableOpacity>
