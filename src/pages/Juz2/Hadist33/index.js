...
const HalamanHadist33 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:19, top:0}}>HADITS Ke-33</Text>
...
paddingTop:20, }}>Kebaikan Adalah dengan Paham Agama</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:1}}>مَنْ يُرِدِ اللهُ بِهِ خَيْرًا يُفَقِّهْهُ فِي الدِّيْنِ 
(متفق عليه)</Text>
</TouchableOpacity>
...
<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist34')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist33