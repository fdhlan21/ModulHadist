...
const HalamanHadist21 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:19, top:0}}>HADIST Ke-21</Text>
...
paddingTop:20, paddingRight:12}}>Kewajiban Menjaga Lisan dan Tangan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>المُسلِمُ مَنْ سَلِمَ الْمُسلِمُوْنَ مِنْ لِسَانِهِ وَيَدِهِ وَالْمُهَاجِرُ مَنْ هَجَرَ مَا نَهَى اللهُ عَنْهُ (رواه البخاري)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Orang muslim adalah orang yang orang-orang muslim lainnya selamat dari lisan dan tangannya. Dan orang yang berhijrah yaitu orang yang menjauhi apa-apa yang telah dilarang oleh Allah.” (HR. Al-Bukhari)
...
export default HalamanHadist21