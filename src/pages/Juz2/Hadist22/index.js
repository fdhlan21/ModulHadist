...
const HalamanHadist22 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:19, top:0}}>HADIST Ke-22</Text>
...
paddingTop:20, }}>Dua Jenis Hasad (Dengki) yang Dibolehkan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>لاَ حَسَدَ إِلاَّ فِي اثْنَتَيْنِ رَجُلٌ آتَاهُ اللهُ الْقُرْآنَ
فَهُوَ يَتْلُوْهُ آنَاءَ اللَّيْلِ وَآنَاءَ النَّهَارِ وَرَجُلٌ آتَاهُ
اللهُ مَالاً فَهُوَ يُنْفِقُهُ آنَاءَ اللَّيْلِ وَآنَاءَ النَّهَارِ (متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Tidak boleh iri kecuali pada dua hal (yang pertama) seseorang yang diberi Al-Quran oleh Allah lalu ia membacanya pada malam dan siang hari, (yang kedua) seseorang yang diberi Allah harta dan dia menginfakkannya pada malam dan siang hari.” (Muttafaq 'Alaih)
...
<TouchableOpacity  activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist21')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist22