...
const HalamanHadist32 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:19, top:0}}>HADITS Ke-32</Text>
...
paddingTop:20, }}>Ridho Allah Ridho Orang Tua</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:1}}>رِضَا اللهِ فِي رِضَا الْوَالِدَيْنِ، وَسُخْطُ اللهِ فِي
سُخْطِ الْوَالِدَيْنِ (رواه البيهقي وصححه ابن حبان)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Ridha Allah pada ridha kedua orangtua, dan murka Allah pada murka kedua orangtua.” (HR. Al-Baihaqi dishahihkan oleh Ibnu Hibban)
...
export default HalamanHadist32