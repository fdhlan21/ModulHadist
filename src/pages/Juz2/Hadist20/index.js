...
const HalamanHadist20 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:19, top:0}}>HADIST Ke-20</Text>
...
paddingTop:20}}>Ancaman bagi Orang yang Suka Meminta-minta</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَا يَزَالُ الرَّجُلُ يَسْأَلُ النَّاسَ حَتَّى يَأْتِيَ يَوْمَ الْقِيَامَةِلَيْسَ فِيْ وَجْهِهِ مُزْعَةُ لَحْمٍ (متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Seorang laki-laki yang suka meminta-minta kepada manusia, kelak jika ia datang pada Hari Kiamat, tidak terdapat sepotong dagingpun di wajahnya.” (Muttafaq 'Alaih)
</Text>
</TouchableOpacity>
</View>
...
export default HalamanHadist20