...
const HalamanHadist19 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:19, top:0}}>HADIST Ke-19</Text>
...
paddingTop:20}}>Keridhaan Allah bagi Orang yang Selalu Memuji Allah dalam Makan Minumnya</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِنَّ اللهَ لَيَرْضَى عَنِ العَبْدِ أَنْ يَأْكُلَ الْأَكْلَةَ
فَيَحْمَدَهُ عَلَيْهَا أَوْيَشْرَبَ الشُّرْبَةَ فَيَحْمَدَهُ عَلَيْهَا (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Sesungguhnya Allah ridha kepada hamba-Nya yang makan makanan lalu memuji Allah atasnya, dan minum minuman lalu memuji Allah atasnya.” 
(HR. Muslim)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist18')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>

<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist20')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist19