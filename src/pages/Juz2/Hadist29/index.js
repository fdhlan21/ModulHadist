...
const HalamanHadist29 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:19, top:0}}>HADITS Ke-29</Text>
...
paddingTop:20, }}>Keutamaan/Fadhilah Silaturahim</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَنْ أَحَبَّ أَنْ يُبْسَطَ لَهُ فِي رِزْقِهِ وَيُنْسَأَ لَهُ فِي
أَثَرِهِ فَلْيَصِلْ رَحِمَهُ (رواه البخاري ومسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Barangsiapa yang ingin dilapangkan rezekinya dan diakhirkan ajalnya maka hendaklah ia bersilaturrahmi.” 
...
export default HalamanHadist29