...
const HalamanHadist25 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:19, top:0}}>HADITS Ke-25</Text>
...
paddingTop:20, }}>Meninggalkan Perkara yang Tidak Manfaat</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مِنْ حُسْنِ إِسْلاَمِ الْمَرْءِ تَرْكُهُ مَا لاَ يَعْنِيْهِ  (رواه الترمذي وقال حديث حسن)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
"Di antara tanda baiknya Islam seseorang ialah meninggalkan apa yang tidak bermanfaat baginya."
...
export default HalamanHadist25