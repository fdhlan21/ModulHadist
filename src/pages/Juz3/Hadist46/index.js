...
const HalamanHadist46 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-46</Text>
...
paddingTop:20}}>Lezatnya Keimanan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>ذَاقَ طَعْمَ الإِيمَانِ مَنْ رَضِيَ بِاللهِ رَبًّا
وَبِالإِسْلاَمِ دِيْنًا وَبِمُحَمَّدٍ رَسُوْلاً (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Akan merasakan kelezatan iman, orang yang ridha/rela menjadikan Allah sebagai Rabbnya dan Islam sebagai agamanya serta Muhammad sebagai Rasulnya.”
(HR. Muslim)
</Text>
</TouchableOpacity>
</View>
...
export default HalamanHadist46