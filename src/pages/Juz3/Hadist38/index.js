...
const HalamanHadist38 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-38</Text>
...
paddingTop:20}}>Kemuliaan Ahlul Qur’an</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِنَّ اللهَ يَرْفَعُ بِهَذَا الْكِتَابِ أَقْوَامًا وَيَضَعُ بِهِ
آخَرِيْنَ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Sesungguhnya Allah mengangkat banyak kaum dengan Kitab ini dan menghinakan banyak kaum dengan Kitab ini.” 
(HR. Muslim)
...
<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist39')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist38