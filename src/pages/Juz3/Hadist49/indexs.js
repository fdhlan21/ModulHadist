...
const HalamanHadist49 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-49</Text>
...
paddingTop:20}}>Permudahlah Jangan Mempersulit</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>يَسِّرُوْا وَلاَتُعَسِّرُوْا وَبَشِّرُوْا وَلاَ تُنَفِّرُوْا (متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Mudahkanlah, jangan mempersulit, berikan kabar gembira, janganlah membuat mereka lari.” (Muttafaq 'Alaih)
...
<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist48')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>



<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist50')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist49