...
const HalamanHadist40 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-40</Text>
...
paddingTop:20}}>Peran Al-Qur’an di Hari Kiamat</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>الْقُرْآنُ حُجَّةٌ لَكَ أَوْ عَلَيْكَ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Al-Qur’an itu merupakan hujjah/argumen yang akan membela atau menuntutmu.” (HR. Muslim)
...
export default HalamanHadist40