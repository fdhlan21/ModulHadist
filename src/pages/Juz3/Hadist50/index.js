...
const HalamanHadist50 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-50</Text>
...
paddingTop:20}}>Menyambung Silaturrahim dengan Teman–Teman Ayah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>أَبَرُّ الْبِرِّ أَنْ يَصِلَ الرَّجُلُ وُدَّ أَبِيْهِ {'\n'}(رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Sesungguhnya sebaik-baik kebajikan adalah seseorang yang menghubungkan tali persaudaraan dengan orang yang dicintai ayahnya.” (HR. Muslim)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity  activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist51')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist50