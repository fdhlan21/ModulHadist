...
const HalamanHadist36 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-36</Text>
...
paddingTop:20}}>Keutamaan Membaca Al-Qur'an</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَنْ قَرَأَ حَرْفًا مِنْ كِتَابِ اللهِ فَلَهُ حَسَنَةٌ،
وَالْحَسَنَةُ بِعَشْرِ أَمْثَالِهَا، لاَ أَقُوْلُ الٓـــمٓ حَرْفٌ،
وَلَكِنْ أَلِفٌ حَرْفٌ وَلاَمٌ حَرْفٌ وَمِيْمٌ حَرْفٌ
(رواه الترمذي وَقَالَ: حَدِيْثٌ حَسَنٌ صَحِيْحٌ)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Barangsiapa membaca satu huruf dari kitabullah, maka baginya satu kebaikan, dan kebaikan itu mendapat pahala sepuluh kali lipat. Aku tidak mengatakan alif laam miim itu satu huruf. Tetapi alif satu huruf, laam satu huruf, dan miim satu huruf.” (HR. At-Tirmidzi, dia berkata: Hadits hasan shohih)
...
<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist35')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist37')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist36