...
const HalamanHadist47 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-47</Text>
...
paddingTop:20}}>Perintah Melakukan Pekerjaan dan Allah Pasti Memudahkan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>اِعْمَلُوْا فَكُلٌّ مُيَسَّرٌ لِمَا خُلِقَ لَهُ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Beramallah kamu sekalian, karena setiap orang dimudahkan terhadap sesuatu yang telah diciptakan untuknya.” (HR. Muslim)
</Text>
</TouchableOpacity>
</View>
...
export default HalamanHadist47