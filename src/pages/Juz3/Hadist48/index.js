...
const HalamanHadist48 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-48</Text>
...
paddingTop:20}}>Keistimewaan Sifat Lemah Lembut</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِنَّ الرِّفْقَ لاَ يَكُوْنُ فِيْ شَيْءٍ إِلاَّ زَانَهُ وَلاَ يُنْزَعُ
مِنْ شَيْءٍ إِلاَّ شَانَهُ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Sesungguhnya kelembutan tidaklah ada pada sesuatu kecuali dia akan menghiasinya, dan tidaklah ia dicabut dari sesuatu melainkan akan memperburuknya.” (HR. Muslim)
...
<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist47')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>



<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist49')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist48