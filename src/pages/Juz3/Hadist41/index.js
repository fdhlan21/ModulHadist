...
const HalamanHadist41 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-41</Text>
...
paddingTop:20}}>Sembilan Puluh Sembilan Asma Allah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِنَّ لِلهِ تِسْعَةً وَتِسْعِينَ اِسْمًا، مِائَةً إِلاَّ وَاحِدًا،
مَنْ أَحْصَاهَا دَخَلَ الْجَنَّةَ (رواه البخاري)</Text>
</TouchableOpacity>
...
Artinya:
“Allah mempunyai sembilan puluh sembilan nama, seratus kurang satu, siapa yg mengihsha'nya (hafal, paham, mengamalkan, dan berdo’a dengannya), maka ia masuk surga.” (HR. Al-Bukhari)
</Text>
</TouchableOpacity>
</View>
...
export default HalamanHadist41