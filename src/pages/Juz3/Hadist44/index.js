...
const HalamanHadist44 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-44</Text>
...
paddingTop:20}}>Keutamaan Saling Mencintai Karena Allah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>لاَ يُؤْمِنُ أَحَدُكُمْ حَتَّى يُحِبَّ لِأَخِيْهِ مَا يُحِبُّ
لِنَفْسِهِ (رواه البخاري ومسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
"Tidak beriman salah seorang di antara kamu hingga dia mencintai untuk saudaranya apa yang dia cintai untuk dirinya sendiri.” (HR. Al-Bukhari dan Muslim)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist45')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist44