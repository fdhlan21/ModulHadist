...
const HalamanHadist43 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-43</Text>
...
paddingTop:20}}>Anjuran Berdo’a dengan Penuh Keyakinan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِذَا دَعَوْتُمُ اللهَ فَاعْزِمُوا فِي الدُّعَاءِ وَلاَ يَقُولَنَّ
أَحَدُكُمْ إِنْ شِئْتَ فَأَعْطِنِي فَإِنَّ اللهَ لاَ
مُسْتَكْرِهَ لَهُ (رواه البخاري)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Jika kalian berdo’a kepada Allah, maka seriuslah dalam berdoa, dan jangan sampai salah seorang di antara kalian berkata: “Jika Engkau berkehendak maka berilah aku”, sebab Allah sama sekali tak ada yang bisa memaksa.” (HR. Al-Bukhari)
...
<TouchableOpacity  activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist42')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist43