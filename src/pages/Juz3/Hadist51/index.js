...
const HalamanHadist51 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-51</Text>
...
paddingTop:20}}>Larangan Melaknat Orang Mukmin</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>لَعْنُ الْمُؤْمِنِ كَقَتْلِهِ (مُتَّفَقٌ عَلَيهِ)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Melaknat orang yang beriman seperti halnya membunuhnya.” (Muttafaq 'Alaih)
...
export default HalamanHadist51