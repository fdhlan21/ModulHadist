...
const HalamanHadist60 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-60</Text>
...
paddingTop:20, paddingRight:2}}>Kewajiban Mencintai Nabi diatas Kecintaan kepada Sesama Manusia Lainnya</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>لاَ يُؤْمِنُ أَحَدُكُمْ حَتَّى أَكُوْنَ أَحَبَّ إِلَيْهِ مِنْ
وَالِدِهِ وَوَلَدِهِ وَالنَّاسِ أَجْمَعِيْنَ (متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
”Tidaklah beriman salah seorang di antara kalian, sehingga aku lebih dicintai olehnya daripada ayahnya, anaknya, dan manusia semuanya.” (Muttafaq 'Alaih)
</Text>
</TouchableOpacity>
</View>
...
<TouchableOpacity  activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist59')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist60