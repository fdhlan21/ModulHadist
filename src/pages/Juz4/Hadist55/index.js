...
const HalamanHadist55 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-55</Text>
...
paddingTop:20}}>Ancaman Bagi Makmum yang Mendahului Imam</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>أَمَا يَخْشَ الَّذِيْ يَرْفَعُ رَأْسَهُ قَبْلَ الْإِمَامِ أَنْ
يُحَوِّلَ اللهُ رَأْسَهُ رَأْسَ حِمَارٍ (مُتَّفَقٌ عَلَيهِ)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Tidak takutkah orang yang mengangkat kepalanya mendahului imam, bahwa Allah akan mengubah kepalanya menjadi kepala keledai.” (Muttafaq 'Alaih)
</Text>
</TouchableOpacity>
</View>
...
export default HalamanHadist55