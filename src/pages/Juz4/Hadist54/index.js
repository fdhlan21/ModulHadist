...
const HalamanHadist54 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-54</Text>
...
paddingTop:20}}>Jangan Berbicara Saat Imam Berkhutbah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِذَا قُلْتَ لِصَاحِبِكَ يَوْمَ الْجُمْعَةِ أَنْصِتْ وَالْإِمَامُ
يَخْطُبُ فَقَدْ لَغَوْتَ (مُتَّفَقٌ عَلَيهِ)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Apabila kamu berkata kepada temanmu pada hari Jum’at ‘diamlah!’ ketika imam berkhutbah, maka kamu telah melakukan hal yang sia-sia.” (Muttafaq 'Alaih)
...
export default HalamanHadist54