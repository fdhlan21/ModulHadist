...
const HalamanHadist63 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-63</Text>
...
paddingTop:20, paddingRight:0}}>Cara Menjawab Adzan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِذَا سَمِعْتُمُ النِّدَاءَ فَقُوْلُوْا مِثْلَ مَا يَقُوْلُ الْمُؤَذِّنُ
(متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Apabila kalian mendengar panggilan adzan maka ucapkan seperti apa yang diucapkan muadzin.” (Muttafaq 'Alaih)
</Text>
</TouchableOpacity>
</View>
...
export default HalamanHadist63