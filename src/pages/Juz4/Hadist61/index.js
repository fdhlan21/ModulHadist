...
const HalamanHadist61 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-61</Text>
...
paddingTop:20, paddingRight:0}}>Menanam Pohon yang Berguna Adalah Sedekah</Text>
</TouchableOpacity> 
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَا مِنْ مُسْلِمٍ يَغْرِسُ غَرْساً أَوْيَزْرَعُ زَرْعًا
فَيَأْكُلُ مِنْهُ طَيْرٌ أَوْ إِنْسَانٌ أَوْ بَهِيْمَةٌ إِلاَّ كَانَ
لَهُ بِهِ صَدَقَةٌ (متفق عليه)</Text>
</TouchableOpacity>
...
Artinya:
“Tidaklah seorang muslim menanam satu tanaman kemudian tanaman itu dimakan burung atau manusia atau hewan ternak lainnya, kecuali baginya itu adalah sedekah.” (Muttafaq 'Alaih)
...
<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist60')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity  activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist62')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist61