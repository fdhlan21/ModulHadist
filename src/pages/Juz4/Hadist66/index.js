...
const HalamanHadist66 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-66</Text>
...
paddingTop:20, paddingRight:0}}>Allah Melihat Hati Kita</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِنَّ اللهَ لاَ يَنْظُرُ إِلَى صُوَرِكُمْ وَأَمْوَالِكُمْ
وَلَكِنْ يَنْظُرُ إِلَى قُلُوبِكُمْ وَأَعْمَالِكُمْ (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Sesungguhnya Allah tidak melihat kepada rupa kalian dan tidak pula kepada harta kalian, tetapi Allah melihat hati kalian dan amal kalian.” (HR. Muslim)
...
export default HalamanHadist66