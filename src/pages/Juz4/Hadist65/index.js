...
const HalamanHadist65 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-65</Text>
...
paddingTop:20, paddingRight:0}}>Larangan Tasyabbuh</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>مَنْ تَشَبَّهَ بِقَوْمٍ فَهُوَ مِنْهُمْ (رواه ابو داود وصححه ابن حبان)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
”Barangsiapa yang menyerupai suatu kaum, maka ia termasuk golongan mereka.” (HR. Abu Dawud dishahihkan Ibnu Hibban)
...
<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist64')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
    <Image style={{width:29, height:20, alignItems:'center', right:5}}  source={require('../../../assets/img/panahkiri.png')}/>
</TouchableOpacity>


<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamanHadist66')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist65