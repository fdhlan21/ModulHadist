...
const HalamanHadist52 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-52</Text>
...
paddingTop:20}}>Beratnya Resiko Berbicara 
Sembarangan</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِنَّ العَبْدَ لَيَتَكَلَّمُ بِالْكَلِمَةِ يَنْزِلُ بِهَا فِي النَّارِ أَبْعَدَ
مَا بَيْنَ المَشْرِقِ وَالمَغْرِبِ (مُتَّفَقٌ عَلَيهِ)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Sesungguhnya seorang hamba berbicara dengan satu kalimat, lalu ia terjerumus ke dalam Neraka karenanya sejauh antara timur dan barat.” (Muttafaq 'Alaih)
...
<TouchableOpacity   activeOpacity={1} onPress={()=> navigation.navigate('HalamanHadist53')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
...
export default HalamanHadist52