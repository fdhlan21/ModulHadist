...
const HalamanHadist58 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-58</Text>
...
paddingTop:20, paddingRight:2}}>Ancaman bagi Tetangga yang Jahat</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>لاَ يَدْخُلُ الْجَنَّةَ مَنْ لاَيَأْمَنُ جَارُهُ بَوَائِقَهُ (رواه مسلم)</Text>
</TouchableOpacity>
...
export default HalamanHadist58