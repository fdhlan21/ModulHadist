...
const HalamanHadist59 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>HADIST Ke-59</Text>
...
paddingTop:20, paddingRight:2}}>Keutamaan Saling Mencintai karena Allah</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20, letterSpacing:2}}>إِنَّ اللهَ يَقُوْلُ يَوْمَ الْقِيَامَةِ أَيْنَ الْمُتَحَابُّوْنَ
بِجَلاَلِي؟ اَلْيَوْمَ أُظِلُّهُمْ فِي ظِلِّي يَوْمَ لاَ ظِلَّ إِلاَّ
ظِلِّي (رواه مسلم)</Text>
</TouchableOpacity>
...
Artinya:
“Sungguh Allah subhanallahu wa ta’alaa akan berkata pada Hari Kiamat, dimana orang yang saling mencintai karena kebesaran-Ku? Pada hari ini Aku akan menaungi mereka dengan naungan-Ku, dimana hari ini tidak ada naungan kecuali naungan-Ku.” (HR. Muslim)
</Text>
</TouchableOpacity>
...
export default HalamanHadist59