...
paddingTop:20}}>Memohon ilmu, rizki dan amal shalih</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20,  letterSpacing:2}}>اَللَّهُمَّ إِنِّيْ أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلاً مُتَقَبَّلاً</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Ya Allah, sesungguhnya aku memohon kepada-Mu ilmu yang bermanfaat, rizki yang baik dan amal yang diterima (di sisi-Mu dan mendapatkan ganjaran yang baik).”{'\n'}
{'\n'}
<Text style={{fontStyle:'italic', fontSize:15}}>(Sanadnya dinyatakan hasan oleh Abdul Qadir dan Syu’aib al-Arnauth dalam Tahqiq Zadul Ma’ad. 2/375)</Text>
</Text>
</TouchableOpacity>
...
<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamaDzikirpagi21')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
