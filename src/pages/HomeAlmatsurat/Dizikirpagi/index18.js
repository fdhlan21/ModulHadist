...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>Dzikir Ke-18</Text>
...
paddingTop:20}}>Mengucapkan tasbih dan tahmid (dibaca 3x)</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20,  letterSpacing:2}}>سُبْحَانَ اللهِ وَبِحَمْدِهِ: عَدَدَ خَلْقِهِ، وَرِضَا نَفْسِهِ، وَزِنَةَ عَرْشِهِ وَمِدَادَ كَلِمَاتِهِ</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Maha Suci Allah, aku memuji-Nya sebanyak ciptaan-Nya, dan keridhaan-Nya, seberat timbangan ‘Arsy-Nya dan sebanyak tinta tulisan kalimat-Nya.” (Shahih Muslim, 4/2090){'\n'}
</Text>
</TouchableOpacity>
...
<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamaDzikirpagi19')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
