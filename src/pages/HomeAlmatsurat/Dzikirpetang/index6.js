...
const Dzikirpetang6 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>Dzikir Ke-6</Text>
...
paddingTop:20}}>Pengakuan atas Tauhid
(dibaca 4x)</Text>
</TouchableOpacity>
...
<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamaDzikirpetang7')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
