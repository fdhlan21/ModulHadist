...
const Dzikirpetang13 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>Dzikir Ke-13</Text>
...
paddingTop:20}}>Pernyataan ridha kepada Allah, Islam dan Nabi Muhammad (dibaca 3x)</Text>
</TouchableOpacity>
...
Artinya:{'\n'}
“Aku ridha Allah sebagai Rabb, Islam sebagai agama dan Muhammad shallallahu ‘alaihi wa sallam sebagai nabiku.”{'\n'}
{"\n"}
<Text style={{fontStyle:'italic', fontSize:15,}}>
“Barangsiapa mengucapkannya sebanyak tiga kali pada waktu pagi dan tiga kali di waktu sore, pasti Allah akan meridhainya pada Hari Kiamat nanti.” (Dinyatakan hasan oleh Ibnu Baaz dalam Tuhfatul Akhyar, hal. 39)
</Text>
</Text>
</TouchableOpacity>
...
<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamaDzikirpetang14')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
