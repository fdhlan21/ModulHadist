...
const Dzikirpetang20 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>Dzikir Ke-20</Text>
...
paddingTop:20}}>Berlindung dari segala kejahatan makhluk (dibaca 3x)</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20,  letterSpacing:2}}>أَعُوْذُ بِكَلِمَاتِ اللهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ</Text>
</TouchableOpacity>
...
{'\n'}
<Text style={{fontStyle:'italic', fontSize:15}}>“Barangsiapa yang mengucapkan 3x pada waktu sore, ia tidak akan terkena bahaya pada malam itu.” (Shahih at-Tirmidzi, 3/187)</Text>
</Text>
</TouchableOpacity>
...
<TouchableOpacity activeOpacity={1} onPress={()=> navigation.navigate('HalamaDzikirpetang21')} style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
