...
const Dzikirpetang21 = ({navigation}) => {
...
<Text style={{fontFamily:'Poppins-SemiBold', color: theme.texttopbar, fontSize:23, left:10, top:0}}>Dzikir Ke-21</Text>
...
paddingTop:20}}>Bershalawat kepada Nabi(dibaca 10x)</Text>
</TouchableOpacity>
...
paddingTop:30, lineHeight:70, paddingRight:20,  letterSpacing:2}}>اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَى نَبِيِّنَا مُحَمَّدٍ</Text>
</TouchableOpacity>
...
{'\n'}
<Text style={{fontStyle:'italic', fontSize:15}}>Barangsiapa yang bershalawat kepadaku 10x di waktu pagi dan sore maka ia akan memperoleh syafa’atku pada hari kiamat. (HR. Thabrani dengan 2 sanad yang salah satunya jayyid dishahihkan al-Bani dalam Shahih at-Targhib wat Tarhib)</Text>
</Text>
</TouchableOpacity>
