...
const Dzikirpetang1 = ({navigation}) => {
...
<Text style={{lineHeight:70, letterSpacing:2, marginBottom:50,}}>
أَعُوْذُ بِااللهِ مِنَ الشَّيْطَانِ الرَّجِيْمِ
</Text>{'\n'}
{'\n'}
...
<TouchableOpacity activeOpacity={1}  onPress={()=> navigation.navigate('HalamaDzikirpetang2')}   style={{width:40, height:40, padding:10, backgroundColor:theme.nexttouch, borderRadius:5}}>
